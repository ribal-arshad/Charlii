        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('brain-storm.update.data', $premise->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" name="brainstorm_name" value="{{old('brainstorm_name', $premise->brainstorm_name)}}" placeholder="Enter book title"/>
                                </div>
                                <div class="col-md-6 mb-6">
