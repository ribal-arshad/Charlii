    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Series</h5>
                <a href="{{route('series.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.series') }}",
                "columns": [
                    { "data" : "user_name","title" : "User Name", "orderable": true, "searchable": true },
                    { "data" : "series_name","title" : "Series Name", "orderable": false, "searchable": false },
                    { "data" : "book","title" : "Book", "orderable": false, "searchable": false },
                    { "data" : "is_finished","title" : "Is Finished?", "orderable": false, "searchable": false },
