...
@section('title', 'Add Chapter Card')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Chapter Card</h5>
                    <div class="card-body">
                        <form action="{{route('card.add.data')}}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" name="card_title" value="{{old('card_title')}}" placeholder="Enter chapter card name"/>
                                </div>
                                <div class="col-md-6 mb-6">
                                    <label class="form-label">Chapter Card Description
                                        <i class="fa fa-asterisk small-font text-danger" aria-hidden="true"></i>
                                    </label>
                                    <textarea class="form-control" name="card_description" placeholder="Enter card_description" cols="3" rows="3">{{ old('card_description') }}</textarea>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
