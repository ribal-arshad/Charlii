...
@section('title', 'Manage Chapter Cards')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Chapter Cards</h5>
                <a href="{{route('card.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
        ...
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "columns": [
                    ...
                    { "data" : "outline_name","title" : "Outline Name", "orderable": false, "searchable": false },
                    { "data" : "chapter_name","title" : "Chapter Name", "orderable": false, "searchable": false },
                    { "data" : "card_title","title" : "Chapter Card Title", "orderable": false, "searchable": false },
