...
@section('title', 'Add Plot Planner')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Plot Planner</h5>
                    <div class="card-body">
                        <form action="{{route('planner.add.data')}}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" name="plot_planner_title" value="{{old('plot_planner_title')}}" placeholder="Enter plot planner title"/>
                                </div>
                                <div class="col-md-6 mb-6">
