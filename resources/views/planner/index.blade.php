...
@section('title', 'Manage Plot Planners')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Plot Planners</h5>
                <a href="{{route('planner.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
        ...
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "columns": [
                    ...
                    { "data" : "plot_planner_title","title" : "Plot Planner Title", "orderable": false, "searchable": false },
