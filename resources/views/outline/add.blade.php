...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Outline</h5>
                    <div class="card-body">
                        <form action="{{route('outline.add.data')}}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" name="outline_name" value="{{old('outline_name')}}" placeholder="Enter outline name"/>
                                </div>
                                <div class="col-md-6 mb-6">
                                    <label class="form-label">Outline Title
                                        <i class="fa fa-asterisk small-font text-danger" aria-hidden="true"></i>
                                    </label>
                                    <input type="text" class="form-control" name="outline_title" value="{{old('outline_title')}}" placeholder="Enter outline title"/>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
