    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Outlines</h5>
                <a href="{{route('outline.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
        ...
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "columns": [
                    ...
                    { "data" : "outline_title","title" : "Outline Title", "orderable": false, "searchable": false },
