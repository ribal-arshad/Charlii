    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Timelines</h5>
                <a href="{{route('timeline.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
        ...
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "columns": [
                    ...
                    { "data" : "name","title" : "Name", "orderable": false, "searchable": false },
                    { "data" : "description","title" : "Description", "orderable": false, "searchable": false },
