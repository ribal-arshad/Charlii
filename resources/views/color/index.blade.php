    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Colors</h5>
                <a href="{{route('color.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.colors') }}",
                "columns": [
                    { "data" : "color","title" : "Color Name", "orderable": true, "searchable": true },
                    { "data" : "color_code","title" : "Color Code", "orderable": false, "searchable": false },
                    { "data" : "foreground_color","title" : "Foreground Color", "orderable": false, "searchable": false },
