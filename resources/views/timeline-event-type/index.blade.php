...
@section('title', 'Manage Timeline Event Type')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Timeline Event Type</h5>
                <a href="{{route('timeline.event.type.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.timeline.event.types') }}",
                "columns": [
                    ...
                    { "data" : "timeline_name","title" : "Timeline Name", "orderable": false, "searchable": false },
                    { "data" : "event_type","title" : "Event Type", "orderable": false, "searchable": false },
