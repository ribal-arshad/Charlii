                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <select name="role" id="role" class="form-select">
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}" {{ old('role', $user->hasRole($role->id)) == $role->id ? 'selected' : '' }}>
                                                {{ $role->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row profile_image_parent mt-3">
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="file" class="form-control" id="profile_picture" name="profile_picture"
                                           value="" />
                                    <img class="mt-3" id="profile_image_preview" src="{{ !empty($user->getFirstMediaUrl('user_profile_image')) ? $user->getFirstMediaUrl('user_profile_image') : asset('assets/img/profiles/default.png') }}" height="250px" width="250px" />
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12">
